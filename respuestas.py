...
def get_response(mesagge: str) -> str:
    ...
    if user_message in [
        "¿cuál es tu campeon favorito?",
        "¿cuál es tu campeon favorito?",
        "cuál es tu campeon favorito?",
        "cual es tu campeon favorito?",
    ]:
    ...
    if contains_any(
        ...
        user_message,
    ) or (contains("mejorar", user_message)):
    ...
    if (
        contains("tu", user_message)
        and contains("mascota", user_message)
        and contains_any(["favorita", "preferida"], user_message)
    ):
